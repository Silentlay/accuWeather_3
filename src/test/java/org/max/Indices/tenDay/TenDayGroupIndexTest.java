...
public class TenDayGroupIndexTest extends AccuweatherAbstractTest {

    @Test
    void getTenDaysOfDailyIndexValuesGroup() {

        Response response = given()
                .queryParam("apikey", getApiKey())
                .when()
                .get(getBaseUrl()+"/indices/v1/daily/10day/295212/1")
                .then()
                .statusCode(401)
        ...
        Assertions.assertTrue(errorResponse.getReference().contains("/indices/v1/daily/10day/295212/1"),
