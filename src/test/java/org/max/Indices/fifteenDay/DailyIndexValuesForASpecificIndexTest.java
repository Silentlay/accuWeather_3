...
public class DailyIndexValuesForASpecificIndexTest extends AccuweatherAbstractTest {

    @Test
    void get15DaysOfDailyIndexValuesForASpecificIndex(){
        Response response = given()
                .queryParam("apikey", getApiKey())
                .when()
                .get(getBaseUrl()+"/indices/v1/daily/15day/295212/1")
                .then()
                .statusCode(401)
        ...
        Assertions.assertTrue(errorResponse.getReference().contains("/indices/v1/daily/15day/295212/1"),
